...
<head>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet"
        href="{{ asset('/stisla-assets/node_modules/bootstrap-social/bootstrap-social.css') }}">
    <!-- Template CSS -->
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <a href="{{ route('beranda') }}"> <img src="{{ asset('/img/logo.png') }}" alt="logo"
                        ...
                        <form method="post" action="{{ route('admin') }}" class="needs-validation"
                            novalidate="">
