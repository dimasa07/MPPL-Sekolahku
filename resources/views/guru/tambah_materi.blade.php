                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu  kt-aside-menu--dropdown " data-ktmenu-vertical="1"
                        ...
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"><a
                                    href="{{ route('guru') }}" class="kt-menu__link"><i
                        ...
                        <div class="row">
                            <div class="col-md-12 bg-white p-4 container"
                                ...
                                <form method="post" enctype="multipart/form-data"
                                    action="{{ route('guru.tambah_materi') }}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input required type="text" readonly name="nama_mapel" value="" class="form-control" id="inputEmail4">
                                        </div>
                                    </div>
